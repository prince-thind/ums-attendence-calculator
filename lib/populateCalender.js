...
const teachersOnLeave = readJSON('./config/teachersOnLeave.json');
const makeups = readJSON('./config/makeups.json');
const weekStructure = readJSON('./config/weekStructure.json');
